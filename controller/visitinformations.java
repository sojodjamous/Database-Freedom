...
public class visitinformations implements Initializable {
    @FXML
    ...
    void add1(ActionEvent event) throws IOException {
        if(add==event.getSource()){
            Parent m = FXMLLoader.load(getClass().getResource("/FXML/addv.fxml"));
    ...
    void up1(ActionEvent event) throws IOException {
        if (up == event.getSource() && !sn.getText().isEmpty()) {
            ...
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/FXML/upvisit.fxml"));
            ...
            upvisit controller = fxmlLoader.<upvisit>getController();
    ...
    void de(ActionEvent event)  throws IOException{
        ...
        try {
            ...
            String insQury1 = "select *From visit order by visitID";
            ...
            String s1="Delete From  visit where visitID= "+sn.getText();
            stm.executeUpdate(s1);
            con.commit();
            String s2="Delete From  visitVisitor where visitID= "+sn.getText();
            stm.executeUpdate(s2);
            con.commit();
            String s="Delete From  visitPrisoner where visitID= "+sn.getText();
            stm.executeUpdate(s);
            con.commit();

            String insQury = "select *From visit order by visitID";
            ResultSet rs = stm.executeQuery(insQury);
